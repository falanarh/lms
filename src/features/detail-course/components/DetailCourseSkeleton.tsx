    ...
    <div className="animate-pulse">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="aspect-video bg-gray-200 dark:bg-zinc-700 rounded-xl"></div>
          <div className="pt-2">
            <div className="h-8 bg-gray-200 dark:bg-zinc-700 rounded w-2/3"></div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-zinc-800 rounded-xl border border-gray-200 dark:border-zinc-700 overflow-hidden">
            ...
            <div className="p-5 border-b border-gray-100 dark:border-zinc-700">
              <div className="h-5 bg-gray-200 dark:bg-zinc-700 rounded w-24 mb-3"></div>
            ...
            <div className="p-5 border-b border-gray-100 dark:border-zinc-700">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="h-3 bg-gray-200 dark:bg-zinc-700 rounded w-16 mb-2"></div>
                  <div className="h-4 bg-gray-200 dark:bg-zinc-700 rounded w-32"></div>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 border-b border-gray-100 dark:border-zinc-700">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <div className="h-3 bg-gray-200 dark:bg-zinc-700 rounded w-20 mb-2"></div>
            ...
            {/* Enroll Button */}
            <div className="p-5">
              <div className="h-12 bg-gray-200 dark:bg-zinc-700 rounded-xl"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-6 pb-8 ">
        <div className="flex justify-center gap-8 border-b border-gray-200 dark:border-zinc-700 w-full">
          {[1, 2, 3, 4].map((i) => (
            <div
              key={i}
              className="h-10 bg-gray-200 dark:bg-zinc-700 rounded flex-1 max-w-[8rem] mb-2"
            ></div>
          ))}
        </div>
