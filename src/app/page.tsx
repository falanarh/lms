...
export default function HomePage() {
  ...
  return (
    <main className="bg-zinc-50 dark:bg-slate-900 transition-colors duration-200">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-14">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
              <span className="text-blue-600 dark:text-blue-400">Platform E-Warkop BPS</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-400 text-base md:text-lg mb-8 max-w-3xl mx-auto">
            ...
            <div className="relative max-w-2xl mx-auto mb-8">
              <input
                ...
                className="w-full px-6 py-4 pr-14 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 bg-blue-600 dark:bg-blue-500 text-white p-2.5 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors">
                <Search size={20} />
              </button>
            </div>
          ...
          <div className="flex justify-center mt-12">
            <div className="size-10 rounded-full border-2 border-blue-600 dark:border-blue-400 flex items-center justify-center animate-bounce cursor-pointer">
              <ChevronRight className="rotate-90 text-blue-600 dark:text-blue-400" size={20} />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-14">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {testimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className="bg-white dark:bg-slate-700 rounded-2xl p-6 shadow-sm hover:shadow-md dark:hover:shadow-lg transition-shadow"
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="size-12 rounded-full bg-gray-200 dark:bg-gray-600 flex-shrink-0 overflow-hidden">
          ...
          <div className="flex justify-center gap-2">
            <button className="size-2 rounded-full bg-blue-600 dark:bg-blue-400"></button>
            <button className="size-2 rounded-full bg-gray-300 dark:bg-gray-600"></button>
            <button className="size-2 rounded-full bg-gray-300 dark:bg-gray-600"></button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white dark:bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-14">
          <div className="text-center mb-4">
            <span className="inline-block bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 px-4 py-1.5 rounded-full text-sm font-medium mb-6">
              AI Powered Learning
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            {aiFeatures.map((feature, index) => (
              <div
                key={index}
                className="bg-white dark:bg-slate-700 rounded-2xl p-8 border border-gray-200 dark:border-gray-600 hover:shadow-lg dark:hover:shadow-xl transition-shadow"
              >
                <div className="size-14 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center mb-6">
      ...
      <section className="py-16 bg-gray-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 xl:px-14">
          <div className="bg-gradient-to-r from-blue-600 to-blue-500 dark:from-blue-700 dark:to-blue-600 rounded-3xl p-8 md:p-12 relative overflow-hidden">
            <div className="relative z-10 max-w-2xl">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Tingkatkan Kompetensi Anda
              </h2>
              <p className="text-blue-100 dark:text-blue-50 mb-8 text-lg">
              ...
              <button className="bg-white text-blue-600 px-8 py-4 rounded-xl font-semibold hover:bg-blue-50 dark:hover:bg-blue-100 transition-colors inline-flex items-center gap-2 shadow-lg">
                Mulai Sekarang
